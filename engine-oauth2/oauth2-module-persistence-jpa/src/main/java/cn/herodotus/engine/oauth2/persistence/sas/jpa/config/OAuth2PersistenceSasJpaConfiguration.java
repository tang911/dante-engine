...
package cn.herodotus.engine.oauth2.persistence.sas.jpa.config;
...
import cn.herodotus.engine.oauth2.persistence.sas.jpa.storage.JpaOAuth2AuthorizationConsentService;
import cn.herodotus.engine.oauth2.persistence.sas.jpa.storage.JpaOAuth2AuthorizationService;
import cn.herodotus.engine.oauth2.persistence.sas.jpa.storage.JpaRegisteredClientRepository;
...
@EntityScan(basePackages = {
        "cn.herodotus.engine.oauth2.persistence.sas.jpa.entity"
})
@EnableJpaRepositories(basePackages = {
        "cn.herodotus.engine.oauth2.persistence.sas.jpa.repository",
})
@ComponentScan(basePackages = {
        "cn.herodotus.engine.oauth2.persistence.sas.jpa.service",
})
