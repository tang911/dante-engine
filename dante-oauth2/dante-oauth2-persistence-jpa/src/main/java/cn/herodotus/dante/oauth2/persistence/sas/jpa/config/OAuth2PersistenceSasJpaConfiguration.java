...
package cn.herodotus.dante.oauth2.persistence.sas.jpa.config;

import cn.herodotus.dante.oauth2.persistence.sas.jpa.service.HerodotusAuthorizationConsentService;
import cn.herodotus.dante.oauth2.persistence.sas.jpa.service.HerodotusAuthorizationService;
import cn.herodotus.dante.oauth2.persistence.sas.jpa.service.HerodotusRegisteredClientService;
import cn.herodotus.dante.oauth2.persistence.sas.jpa.storage.JpaOAuth2AuthorizationConsentService;
import cn.herodotus.dante.oauth2.persistence.sas.jpa.storage.JpaOAuth2AuthorizationService;
import cn.herodotus.dante.oauth2.persistence.sas.jpa.storage.JpaRegisteredClientRepository;
...
@EntityScan(basePackages = {
        "cn.herodotus.dante.oauth2.persistence.sas.jpa.entity"
})
@EnableJpaRepositories(basePackages = {
        "cn.herodotus.dante.oauth2.persistence.sas.jpa.repository",
})
@ComponentScan(basePackages = {
        "cn.herodotus.dante.oauth2.persistence.sas.jpa.service",
})
