...
/**
 * <p>Description: 响应式对象存储 Object 操作 Service </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/7/26 16:19
 */
@Service
public class ReactiveObjectService extends AbstractReactiveService {

    private final S3AsyncClientObjectService objectService;
    private final S3AsyncClientCompositeService compositeService;

    public ReactiveObjectService(S3AsyncClientObjectService objectService, S3AsyncClientCompositeService compositeService) {
        this.objectService = objectService;
        this.compositeService = compositeService;
    }

    public Mono<HeadObjectResult> headObject(HeadObjectArgument argument) {
    ...
    public Mono<DeleteObjectResult> deleteObject(DeleteObjectArgument argument) {
    ...
    public Mono<DeleteObjectsResult> deleteObjects(DeleteObjectsArgument argument) {
    ...
    public Mono<GetObjectResult> getObject(GetObjectArgument argument) {
    ...
    public Mono<ListObjectsV2Result> listObjectsV2(ListObjectsV2Argument argument) {
    ...
    public Mono<PutObjectResult> putObject(PutObjectArgument argument, AsyncRequestBody requestBody) {
    ...
    public Mono<WriteGetObjectResponseResult> writeGetObjectResponse(WriteGetObjectResponseArgument argument, AsyncRequestBody requestBody) {
    ...
    public Mono<GetObjectAttributesResult> getObjectAttributes(GetObjectAttributesArgument argument) {
        return process(argument, new ArgumentToGetObjectAttributesRequestConverter(), compositeService::getObjectAttributes);
    }

    public Mono<PutObjectLegalHoldResult> putObjectLegalHold(PutObjectLegalHoldArgument argument) {
    ...
    public Mono<PutObjectRetentionResult> putObjectRetention(PutObjectRetentionArgument argument) {
